    ...
    return new Promise((resolve, reject) => {
        (0, child_process_1.exec)(`pkill -f appium`, (error, stdout) => {
            if (error) {
                ...
                // Don't reject - treat this as successful cleanup since the server is likely already stopped
                logger_1.logger.log("Appium server stopped successfully (or was already stopped).");
                resolve(stdout);
            } else {
