...
export default defineConfig({
  ...
  projects: [
	...
	buildPath: path.join("/home/aqw/project/QualGent_Backend/job-server-node/builds", "wikipedia.apk"),
       // buildPath: path.join("/mnt/data/apk-storage", "wikipedia.apk"), //For containerized implementation
        video: "off",
      },
    },
    {
      ...
      use: {
        ...
        device: {
          provider: "local-device",
          name: process.env.IOS_SIMULATOR_HOST || "34.29.247.79:4723",
        },
        ...
        webDriverUrl: "http://34.29.247.79:4723/wd/hub",
